        ...
        <main class="main-content">
            ...
            <section id="course-details" class="section">
                ...
                <form action="create_course.php" method="POST">
                    ...
                    <input type="number" id="assignment_weight" name="assignment_weight" required><br> <br>

                    <label for="quiz_weight">Quiz Weight (%):</label>
                    <input type="number" id="quiz_weight" name="quiz_weight" required><br> <br>

                    <label for="exam_weight">Exam Weight (%):</label>
                    <input type="number" id="exam_weight" name="exam_weight" required><br> <br>
