        ...
        <div class="form-section">
            ...
            <form action="" method="POST" class="question-form">
                ...
                <div class="form-group" id="answer-section" style="display:none;">
                    ...
                    <textarea id="correct_answer" name="correct_answer" rows="2"></textarea>
                </div>
...
<script>
    ...
    document.getElementById('add-option').addEventListener('click', function() {
        ...
        // Append the new option input and a line break
        optionsDiv.appendChild(newOptionInput);
        optionsDiv.appendChild(document.createElement('br'));
        
        // Dynamically add new option to the "Correct Option" dropdown
        var correctOptionSelect = document.getElementById('correct_option');
        var newOptionIndex = correctOptionSelect.options.length;
        var newOption = document.createElement('option');
        newOption.value = newOptionIndex;
        newOption.text = 'Option ' + (newOptionIndex + 1); // Displaying Option 3, Option 4, etc.
        correctOptionSelect.appendChild(newOption);
    });

    // Initialize the correct form section on page load based on the selected question type
