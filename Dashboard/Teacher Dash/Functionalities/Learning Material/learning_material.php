                            ...
                            <ul>
                                <?php foreach ($learning_materials as $material_item): ?>
                                    <li>
                                        ...
                                        <p><?php echo htmlspecialchars($material_item['description']); ?></p>

                                        <!-- Add Download Link -->
                                        <a href="download_material.php?material_id=<?php echo $material_item['learning_materials_id']; ?>">Download File</a>
