        ...
        <main class="main-content">
            ...
            <section id="course-details" class="section">
                <?php if (!empty($coursesList)): ?>
                    <?php if ($course_id && $current_course): ?>
                                        ...
                                        <div class="assignment-item">
                                            ...
                                            <?php if (!$isGraded): ?>
                                                <div class="assignment-actions">
                                                    ...
                                                    <?php else: ?>
                                                        <br><br><a href="Functionalities/Assignments/assignment_submission.php?assignment_id=<?php echo $assignmentData['assignment_id']; ?><?php echo $submission ? '&edit=1' : ''; ?>"
                                                            class="button">
